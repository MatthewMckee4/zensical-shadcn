...
## title: Iconify summary: Insert any icon in your documentation external_links: Icons: <https://icon-sets.iconify.design/> "Iconify API": <https://iconify.design/docs/api/svg.html#query>
