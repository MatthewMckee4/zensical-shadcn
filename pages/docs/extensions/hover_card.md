...
## title: Hover Card summary: A rich tooltip new: true

This extension tries to mimic the [shadcn hover card component](https://ui.shadcn.com/docs/components/radix/hover-card) (just html and css).
