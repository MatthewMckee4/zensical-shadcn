...
## title: Pages summary: Metadata configuration show_datetime: true
...
The [`show_datetime` theme option](./10_get_started.md#show_datetime-bool) can be overridden per page
