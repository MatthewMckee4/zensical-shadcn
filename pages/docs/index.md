...
## title: Welcome to mkdocs-shadcn summary: Beautifully designed mkdocs theme sidebar_title: Home description: Documentation that also shines image: <https://raw.githubusercontent.com/asiffer/mkdocs-shadcn/master/.github/assets/banner.png> keywords: "mkdocs, shadcn, python" external_links: "shadcn/ui": <https://ui.shadcn.com/docs>
...
```
You can easily migrate to this theme if your documentation does not rely on too many extensions/plugins. Of course, this is also a good choice for your next brand new project!
```
